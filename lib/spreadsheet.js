...
class Spreadsheet {
  ...
  async getSheet(
    ...
    const sheet = this.createSheet(sheetName, sheetInfo, {
      filter,
      validator,
      formatter
    });
  ...
  async getSheetMap(
    ...
    return _.transform(
      ...
      (map, info, i) => {
        ...
        const sheet = this.createSheet(name, info, opts);
   ...
   * @private
   */
  createSheet(name, info, opts) {
    opts = Object.assign({}, this.options, opts);
    return new Sheet(name, info, opts)
  }
}
